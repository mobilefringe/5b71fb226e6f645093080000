        ...
        return Vue.component("coupon-basket-component", {
            ...
            methods: {
                ...
                printPage() {
                    ...
                    html += '<head></head>';
                    html += "<body><div style='text-align:center;'><img style='max-width: 250px; padding: 15px 0;' src='//codecloud.cdn.speedyrails.net/sites/5d70146b6e6f641ac8520200/image/png/1535042524544/dtl_600x180_logo.png' style='width:200px;'/></div>";
