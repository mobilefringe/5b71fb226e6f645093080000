        ...
        return Vue.component("home-component", {
            ...
            methods: {
                loadData: async function() {
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "banners"), this.$store.dispatch("getData","promotions"), this.$store.dispatch("getData", "events"), this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/api/v4/district/social.json"})]);
                        return results;
                    } catch(e) {
