            ...
            <div class="footer_content">
                <div class="row main_container">
                    ...
                    <div class="footer_links">
                        <p><a href="/pages/district-code-of-conduct" target="_blank">Code of Conduct</a> | <a :href="/pages/"+siteInfo.subdomain+"-privacy-policy/" target="_blank">Privacy Policy</a></p>
                    </div>
                </div>
            </div>
            <div class="copyright">
