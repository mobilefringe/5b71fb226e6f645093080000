                                ...
                                <div class="row margin_30">
                                    <div class="col-md-12">
                                        <router-link to="/promotions">
                    		                <div class="animated_btn coupon_detail_btn pull-left">Add To Basket</div>    
                    		            </router-link>  
        ...
        return Vue.component("coupon-details-component", {
            ...
            methods: {
			    ...
			    printPage(currentCoupon) {
                    ...
                    if(field != null && !_.includes(this.currentCoupon.promo_image_url_abs, 'missing')) html += "<img style='padding: 20px; max-width: 100%;' src=" + field + "></div><div style='width:50%; display: inline-block;'>";
