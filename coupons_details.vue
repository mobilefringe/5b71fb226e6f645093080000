    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-if="pageBanner" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url(' + pageBanner.image_url + ') center center #012e45' }">
                ...
                this.loadData().then(response => {
					...
					if (this.currentCoupon === null || this.currentCoupon === undefined) {
                        ...
                        if (this.currentCoupon.promotionable_type === "Store"){
                            ...
                            //     this.currentCoupon.image_url = "//codecloud.cdn.speedyrails.net/sites/5d70146b6e6f641ac8520200/image/png/1529532181000/promoplaceholder2@2x.png";
                            // } else {
